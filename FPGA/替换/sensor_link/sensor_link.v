// ============================================================================
// sensor_link.v -- 传感器链集成核（三模式追踪版 V4）
//
// V3 改动：新增 warn_level 输入端口（ttc_warn 输出）透传给 tracker_ctrl V4，
//   实现 TTC 预警联动（黄警半速、红警停车）。
// V4 改动：配合 v1_decode V1.2（35 字节帧），新增 disp_mode 输出——遥控器
//   左拨杆 s1 映射的显示模式（0=视角 1=轨迹 2=调试），送顶层 mode_switch。
...
module sensor_link #(
    ...
    output wire       [ 1:0]  disp_mode,      // [V4] 遥控显示模式 0=视角 1=轨迹 2=调试
