// ============================================================================
// protocol_v1.h —— V1.0 上行传感器帧 + V1.1 下行控制帧（与 FPGA 端严格对应）
//
// 上行 V1.0 (ESP32 → FPGA, 100Hz, 34 字节，全小端)：
//   AA 55 | 版本=0x01 | timestamp(2) | enc[4]×4 | gyro[3]×2 | acc[3]×2 | CRC8
//   CRC8/SMBUS：多项式 0x07、初值 0x00，覆盖版本 ~ acc[2] 共 31 字节
//
