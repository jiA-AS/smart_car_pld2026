...
// Created by:          正点原子
// Created date:        2025年10月25日13:10:00
// Version:             V1.0
// Descriptions:        iic配置
//
//----------------------------------------------------------------------------------------
...
module i2c_ov5640_rgb565_cfg
   (  
    ...
    input        [12:0]  y_addr_st,     //开窗垂直方向起始地址
    input        [12:0]  y_addr_end,    //开窗垂直方向起始地址
...
always @(posedge clk or negedge rst_n) begin
    if(!rst_n)
        ...
        start_init_cnt <= start_init_cnt + 13'd1;                    
    end
end
...
always @(posedge clk or negedge rst_n) begin
    if(!rst_n)
        ...
        init_reg_cnt <= init_reg_cnt + 8'd1;
end
