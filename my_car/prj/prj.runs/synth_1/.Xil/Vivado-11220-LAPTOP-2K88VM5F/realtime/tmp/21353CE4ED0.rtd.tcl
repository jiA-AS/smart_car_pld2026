...
set genomeRtd $env(RT_TMP)/21353CE4ED0.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {dash_osd__GB5}]"
...
set genomeName [subst -nocommands -novariables {dash_osd__GB5}]
