...
set genomeRtd $env(RT_TMP)/2130F7630C0.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {dash_osd__GB3}]"
...
set genomeName [subst -nocommands -novariables {dash_osd__GB3}]
