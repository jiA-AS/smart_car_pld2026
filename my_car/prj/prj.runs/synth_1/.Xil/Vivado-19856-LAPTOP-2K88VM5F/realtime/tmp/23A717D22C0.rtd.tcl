...
set genomeRtd $env(RT_TMP)/23A717D22C0.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {top_dual_ov5640_lcd__GCB2}]"
...
set genomeName [subst -nocommands -novariables {top_dual_ov5640_lcd__GCB2}]
