...
set genomeRtd $env(RT_TMP)/23A75CD28C0.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {osd_overlay__GB6}]"
...
set genomeName [subst -nocommands -novariables {osd_overlay__GB6}]
