...
set genomeRtd $env(RT_TMP)/286C212B630.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {lcd_rgb_top__GC0}]"
...
set genomeName [subst -nocommands -novariables {lcd_rgb_top__GC0}]
