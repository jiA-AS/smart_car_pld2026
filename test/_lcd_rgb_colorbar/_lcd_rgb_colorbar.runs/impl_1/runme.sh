...
HD_PWD='E:/FPGA/project/smart_car_pld2026/test/_lcd_rgb_colorbar/_lcd_rgb_colorbar.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lcd_rgb_colorbar.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lcd_rgb_colorbar.tcl -notrace
