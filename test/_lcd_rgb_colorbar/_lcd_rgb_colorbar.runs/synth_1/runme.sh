...
HD_PWD='E:/FPGA/project/smart_car_pld2026/test/_lcd_rgb_colorbar/_lcd_rgb_colorbar.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lcd_rgb_colorbar.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lcd_rgb_colorbar.tcl
