...
HD_PWD='D:/Project/FPGA/Project_up/XZ7A100T/45_top_uart_packet/prj/top_uart_packet.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_uart_packet.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_uart_packet.tcl -notrace
