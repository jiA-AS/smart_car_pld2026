...
HD_PWD='D:/Project/FPGA/Project_up/XZ7A100T/45_top_uart_packet/prj/top_uart_packet.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_uart_packet.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_uart_packet.tcl
