...
HD_PWD='E:/FPGA/project/smart_car_pld2026/test/top_dual_ov5640_lcd/top_dual_ov5640_lcd.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_dual_ov5640_lcd.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_dual_ov5640_lcd.tcl -notrace
