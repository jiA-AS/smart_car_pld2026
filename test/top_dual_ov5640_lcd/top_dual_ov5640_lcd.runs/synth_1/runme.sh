...
HD_PWD='E:/FPGA/project/smart_car_pld2026/test/top_dual_ov5640_lcd/top_dual_ov5640_lcd.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_dual_ov5640_lcd.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_dual_ov5640_lcd.tcl
